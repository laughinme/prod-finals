...
class AnalyticsDailyFunnel(TimestampMixin, Base):
    ...
    feed_explanation_opened: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    ...
    chat_first_message_sent: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    chat_first_reply_received: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
