...
_FIRST_NAMES = {
    "male": ("Алексей", "Илья", "Иван", "Михаил", "Никита", "Роман", "Максим", "Кирилл"),
    "female": ("Анна", "Мария", "Екатерина", "Ольга", "Алина", "София", "Дарья", "Полина"),
}
_LAST_NAMES = ("Иванов", "Петров", "Смирнов", "Кузнецов", "Соколов", "Попов", "Лебедев", "Козлов")
