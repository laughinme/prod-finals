...
export function MatchPreferencesQuestion({
  ...
  return (
    <div className="space-y-5 py-1 md:space-y-8 md:py-2">
          ...
          {question.options.map((option) => {
            ...
            return (
              <button
                ...
                className={
                  "rounded-xl border px-3 py-2.5 text-sm font-medium transition-all md:rounded-2xl md:px-4 md:py-3 " +
                  (isSelected
      ...
      <div className="rounded-2xl border border-border/60 bg-secondary/20 p-4 md:rounded-3xl md:p-5">
